...
$_lang['setting_reviews.editor_plugins_desc']           = 'De \'plugins\' config voor de rich text editor.';
$_lang['setting_reviews.editor_toolbar1']               = 'Toolbar 1';
$_lang['setting_reviews.editor_toolbar1_desc']          = 'De \'toolbar1\' config voor de rich text editor.';
$_lang['setting_reviews.editor_toolbar2']               = 'Toolbar 2';
$_lang['setting_reviews.editor_toolbar2_desc']          = 'De \'toolbar2\' config voor de rich text editor.';
$_lang['setting_reviews.editor_toolbar3']               = 'Toolbar 3';
$_lang['setting_reviews.editor_toolbar3_desc']          = 'De \'toolbar3\' config voor de rich text editor.';
$_lang['setting_reviews.editor_menubar']                = 'Menubar';
$_lang['setting_reviews.editor_menubar_desc']           = 'De \'menubar\' config voor de rich text editor.';
$_lang['setting_reviews.editor_statusbar']              = 'Statusbar';
$_lang['setting_reviews.editor_statusbar_desc']         = 'De \'statusbar\' config voor de rich text editor.';
...
$_lang['reviews.label_name']                            = 'Naam';
$_lang['reviews.label_name_desc']                       = 'De naam van de reviewer.';
$_lang['reviews.label_email']                           = 'E-mailadres';
$_lang['reviews.label_email_desc']                      = 'Het e-mailadres van de reviewer.';
$_lang['reviews.label_rating']                          = 'Beoordeling';
$_lang['reviews.label_rating_desc']                     = 'De beoordeling van de review.';
$_lang['reviews.label_content']                         = 'Review';
$_lang['reviews.label_content_desc']                    = 'De review.';
$_lang['reviews.label_active']                          = 'Actief';
$_lang['reviews.label_active_desc']                     = '';

$_lang['reviews.filter_resource']                       = 'Filter op pagina';
$_lang['reviews.rating_0']                              = 'sterren';
